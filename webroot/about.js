const ABOUT_TRANSLATIONS = {
  "zh-CN": {
    ...
    featurePlayback: "可设置循环次数（1–10 次），以拼接帧方式确保循环在所有设备生效。",
  ...
  "zh-TW": {
    ...
    featurePlayback: "可設定循環次數（1–10 次），以拼接幀方式確保循環在所有裝置生效。",
  ...
  "en-US": {
    ...
    featurePlayback: "Set the loop count (1-10); frames are spliced so looping works on every device.",
