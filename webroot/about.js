const ABOUT_TRANSLATIONS = {
  "zh-CN": {
    ...
    featurePlayback: "可设置循环次数（1–20 次），以拼接帧方式确保循环在所有设备生效。",
    featureSpeed: "可调播放速度（0.25–4×）。",
    featureRotate: "可旋转视频 0-360°（可斜着摆放），带实时预览。",
    featureClip: "可截取视频片段：设置开始 / 结束时间，只转换需要的部分。",
  ...
  "zh-TW": {
    ...
    featurePlayback: "可設定循環次數（1–20 次），以拼接幀方式確保循環在所有裝置生效。",
    featureSpeed: "可調播放速度（0.25–4×）。",
    featureRotate: "可旋轉影片 0–360°（可斜著擺放），帶即時預覽。",
    featureClip: "可截取影片片段：設定開始 / 結束時間，只轉換需要的部分。",
  ...
  "en-US": {
    ...
    featurePlayback: "Set the loop count (1-20); frames are spliced so looping works on every device.",
    featureSpeed: "Adjustable playback speed (0.25-4×).",
    featureRotate: "Rotate the video 0-360° (tilt it), with a live preview.",
    featureClip: "Clip the video to a segment (set start and end time) and convert only the part you need.",
